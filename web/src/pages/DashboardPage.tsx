          ...
          <div ref={userMenuRef} style={{ position: 'relative' }}>
            ...
            {userMenuOpen && (
              <div style={{ position: 'absolute', right: 0, top: 50, background: 'white', borderRadius: 12, boxShadow: '0 8px 32px rgba(30,45,80,0.15)', border: '1px solid rgba(30,45,80,0.08)', minWidth: 180, zIndex: 50, overflow: 'hidden' }}>
                ...
                <button onClick={() => { setUserMenuOpen(false); navigate('/settings') }} style={{ display: 'block', width: '100%', padding: '10px 16px', textAlign: 'left', background: 'none', border: 'none', fontSize: 13, color: '#15203a', cursor: 'pointer' }}>⚙️ Settings</button>
